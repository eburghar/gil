...
use openidconnect::{
    ...
    EmptyAdditionalClaims, EmptyExtraTokenFields, IdTokenFields, StandardTokenResponse,
};
...
impl OAuth2Token {
    ...
    pub fn from_cache(host: &str) -> Option<Self> {
        ProjectDirs::from("me", ORG, env!("CARGO_BIN_NAME"))
    ...
    pub fn save(&self, host: &str) -> Result<()> {
        ProjectDirs::from("me", ORG, env!("CARGO_BIN_NAME"))
...
//     fn into(self) -> String {
//         self.0.access_token().secret().to_owned()
//     }
// }
